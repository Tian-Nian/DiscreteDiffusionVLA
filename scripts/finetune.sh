...
REPO_ROOT="/mnt/pfs/pg4hw0/niantian/DiscreteDiffusionVLA" # path to the openvla-oft repo
MODEL_DIR="/mnt/pfs/pg4hw0/niantian/model_weights/openvla-7b" # path to the pretrained OpenVLA model. You can change this to your own path if you have a different pretrained model.
DATA_ROOT="/mnt/pfs/pg4hw0/niantian/tensorflow_datasets" # path to the directory containing the TFDS datasets. This should be the same as the TFDS_DATA_DIR in build_tfds_aloha.sh. Change this to your own path if needed.
export HF_HOME="/mnt/pfs/pg4hw0/niantian/.cache/huggingface" # set the Hugging Face cache directory. This is where the pretrained model and tokenizer will be cached. Change this to your desired path.
